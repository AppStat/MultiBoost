 ...
 */
    ...
    protected:
         ...
         * \date 19/07/2006
         */
        virtual AlphaReal phi(InputData* pData, int idx, int classIdx) const = 0;
         ...
         * \date 12/11/2005
         */
        virtual AlphaReal getEnergy(vector<sRates>& mu, AlphaReal& alpha, vector<AlphaReal>& v);
         ...
         * \date 28/11/2005
         */
        virtual AlphaReal doGreedyAbstention(vector<sRates>& mu,  AlphaReal currEnergy, 
         ...
         * \date 28/11/2005
         */
        virtual AlphaReal doFullAbstention(const vector<sRates>& mu,  AlphaReal currEnergy, 
                                           sRates& eps, AlphaReal& alpha, vector<AlphaReal>& v);
         ...
         */
        virtual AlphaReal doRealAbstention(const vector<sRates>& mu, const sRates& eps,
         ...
         * \date 27/04/2007
         */
        virtual AlphaReal doClasswiseAbstention(vector<sRates>& mu,  
                                                sRates& eps, AlphaReal& alpha, vector<AlphaReal>& v);
