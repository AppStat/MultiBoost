...
/**
 * \file MultiThresholdStumpLearner.h A multi threshold decision stump learner.
 */

#ifndef __MULTI_THRESHOLD_STUMP_LEARNER_H
#define __MULTI_THRESHOLD_STUMP_LEARNER_H
 ...
 */
    class MultiThresholdStumpLearner : public FeaturewiseLearner
    {
    public:
         ...
         * the object.
         */
        virtual ~MultiThresholdStumpLearner() {}
         ...
         * \date 14/11/2005
         */
        virtual BaseLearner* subCreate() { return new MultiThresholdStumpLearner(); }
