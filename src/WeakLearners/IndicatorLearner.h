...
/**
 * \file IndicatorLearner.h A single indicator learner for nominal features.
 */
...
namespace MultiBoost {
     ...
     */
    class IndicatorLearner : virtual public FeaturewiseLearner, public virtual ScalarLearner
    {
    public:
    ...
    IndicatorLearner() : FeaturewiseLearner() {}
         ...
         * \date 21/05/2007
         */
        virtual BaseLearner* subCreate() { return new IndicatorLearner(); }
