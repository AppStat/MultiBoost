...
namespace MultiBoost {
    ...
    protected:
        ...
        vector< AlphaReal >                                     _X;     // the sum of reward for the features
    ...
    public:
        /**
         * The constructor. It initilaizes the member variables, such as number of arms and number of iteration will be taken.
         * \date 30/03/2010 
         */
    GenericBanditAlgorithm(void) : _numOfArms( -1 ), _numOfIter( 2 ), _isInitialized( false ), _serializationFlag( false ) {}
        ...
        /**
         * Receive reward and updates the statistics, i.e. the sum of reward of an arm
         * and the number of this arm had been pulled.
         * \param armNum The index of arm has been pulled.
         * \param reward The reward is incurred by the action, i.e. pulling an arm. 
         * \date 30/03/2010
         */
         ...
         * \return The number of iteration step.
         * \date 30/03/2010
         */
         ...
         * \param k number of arms to be pulled in the same iteration
         * \param bestArms integer vector containing the indices of arms will be pulled
         * \date 30/03/2010
         */     
        ...
        /**
         * Get the best action.
         * \return The index of arm which then will be pulled.
         * \date 30/03/2010
         */
        ...
        /**
         * Get the state of object whether it is already initialized or not.
         * \date 30/03/2010
         */
         ...
         * sets the flag because all bandit algorithm has an own initialization process.
        ...
        /**
         * Set the arguments of the algorithm using the standard interface of the argument 
         * handling (see in the weak learners). Call this to set the arguments given by the user.
