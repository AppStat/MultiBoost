 ...
 */
    ...
    Args() : _currentGroup("general"), _maxColumns(60), _argDiscriminator(""), _configFileString("configfile"){}
        ...
        /**
         * Add an argument from within Multiboost.
         * Useful in case some classes want to communicate each other arguments
         */
    
        void addArgumentOnTheFly(const string & name, int numValues, ...);
