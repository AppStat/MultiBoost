...
#include "Classifiers/BrownBoostClassifier.h"
...
namespace MultiBoost {
	...
	BrownBoostClassifier::BrownBoostClassifier(const nor_utils::Args &args, int verbose)
	...
	void BrownBoostClassifier::run(const string& dataFileName, const string& shypFileName, 
	...
	void BrownBoostClassifier::printConfusionMatrix(const string& dataFileName, const string& shypFileName)
	{
		InputData* pData = loadInputData(dataFileName, shypFileName);
	...
	void BrownBoostClassifier::saveConfusionMatrix(const string& dataFileName, const string& shypFileName,
	...
	void BrownBoostClassifier::savePosteriors(const string& dataFileName, const string& shypFileName, 
	...
	void BrownBoostClassifier::saveCalibratedPosteriors(const string& dataFileName, const string& shypFileName, 
		const string& outFileName, int numIterations)
	{
		InputData* pData = loadInputData(dataFileName, shypFileName);
	...
	void BrownBoostClassifier::saveLikelihoods(const string& dataFileName, const string& shypFileName, 
		const string& outFileName, int numIterations)
	{
		InputData* pData = loadInputData(dataFileName, shypFileName);
	...
	//void BrownBoostClassifier::saveSingleStumpFeatureData(const string& dataFileName, 
	...
	InputData* BrownBoostClassifier::loadInputData(const string& dataFileName, const string& shypFileName)
	{
		// open file
	...
	void BrownBoostClassifier::computeResults(InputData* pData, vector<BaseLearner*>& weakHypotheses, 
	...
	float BrownBoostClassifier::getOverallError( InputData* pData, const vector<ExampleResults*>& results, 
		int atLeastRank )
	{
		const int numExamples = pData->getNumExamples();
		int numErrors = 0;
	...
	void BrownBoostClassifier::getClassError( InputData* pData, const vector<ExampleResults*>& results, 
