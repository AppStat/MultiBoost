...
/**
* \file BrownBoostClassifier.h Performs the classification with BrownBoost.
*/
#pragma warning( disable : 4786 )

#ifndef __BROWNBOOST_CLASSIFIER_H
#define __BROWNBOOST_CLASSIFIER_H
...
public:
   ...
   * \date 16/11/2005
   */
   BrownBoostClassifier(const nor_utils::Args& args, int verbose = 1);
...
private:
   ...
   * \date 6/12/2005
   */
   BrownBoostClassifier& operator=( const BrownBoostClassifier& ) {return *this;}
