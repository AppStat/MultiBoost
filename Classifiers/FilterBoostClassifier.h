...
/**
* \file FilterBoostClassifier.h Performs the classification with FilterBoost.
*/
...
/**
* Classify a dataset with FilterBoost. learner.
...
public:
   ...
   * \date 16/11/2005
   */
   FilterBoostClassifier(const nor_utils::Args& args, int verbose = 1);
   ...
   */
   ...
   void saveROC(const string& dataFileName, const string& shypFileName,
                       const string& outFileName, int numIterations);
...
private:
   ...
   * \date 6/12/2005
   */
   FilterBoostClassifier& operator=( const FilterBoostClassifier& ) {return *this;}
