...
* \link MultiBoost::AdaBoostMHClassifier AdaBoostMHClassifier\endlink 
...
#include "Classifiers/AdaBoostMHClassifier.h" // just for -ssfeatures
...
int main(int argc, const char* argv[])
{
   ...
   args.declareArgument( "fileformat", "Defines the type of intput file. Available types are:\n" 
									   ...
									   "* libsvm: as it used to be\n"
                                       "(Example: --fileformat simple)",
                         1, "<fileFormat>" );

   args.declareArgument("hierarchyFile", "The filename of the hyerachyfile (LSHTC).", 1, "cat_hier.txt");
   ...
   else if ( args.hasArgument("ssfeatures") )
   {
      ...
      //AdaBoostMHClassifier classifier(args, verbose);
