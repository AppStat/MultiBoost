...
namespace MultiBoost {
	...
	ArffParser::ArffParser(const string& fileName)
	...
	void ArffParser::readDenseValues(ifstream& in, vector<float>& values,
	...
	void ArffParser::readSparseValues(istringstream& ss, vector<float>& values, 
