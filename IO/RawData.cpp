...
namespace MultiBoost {
	...
	void RawData::initOptions(const nor_utils::Args& args)
	{
		...
		/////////////////////////////////////////////////////////////////////
		// for the libsvm file format, the hierarchy is stored in a separate file
		if ( args.hasArgument("hierarchyFile") )
		{
			_hierarchyFile = args.getValue<string>("hierarchyFile");
		}
	...
	void RawData::initWeights()
	{
		...
		if ( !nor_utils::is_zero(sumWeight-1.0) )
		{
