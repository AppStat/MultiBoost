...
namespace MultiBoost {
	...
	float Selector::phi(float val, int /*classIdx*/) const
	{
	...
	void Selector::save(ofstream& outputStream, int numTabs)
	{
	...
	void Selector::load(nor_utils::StreamTokenizer& st)
	{
		// Calling the super-class method
	...
	void Selector::subCopyState(BaseLearner *pBaseLearner)
	{
		FeaturewiseLearner::subCopyState(pBaseLearner);

		Selector* pSelector =
			dynamic_cast<Selector*>(pBaseLearner);
