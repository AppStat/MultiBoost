...
#ifndef __DIRICHLET_SINGLE_STUMP_LEARNER_H
...
*/
class DirichletSingleStumpLearner : public FeaturewiseLearner
{
public:
   ...
   * the object.
   */
   virtual ~DirichletSingleStumpLearner() {}
   ...
   * \date 14/11/2005
   */
   virtual BaseLearner* subCreate() { return new DirichletSingleStumpLearner(); }
...
protected:
   ...
   */
   ...
   static vector< float > _featurewiseMax; // the everage reward of a feature
   static vector< float > _featurewiseMin; // the everage reward of a feature
