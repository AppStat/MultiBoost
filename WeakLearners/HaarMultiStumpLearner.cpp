...
float HaarMultiStumpLearner::classify(InputData* pData, int idx, int classIdx)
{
...
float HaarMultiStumpLearner::run()
{
...
float HaarMultiStumpLearner::phi(float val, int classIdx) const
{
