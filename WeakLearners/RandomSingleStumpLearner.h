...
#ifndef __Random_SINGLE_STUMP_LEARNER_H
#define __Random_SINGLE_STUMP_LEARNER_H
...
*/
class RandomSingleStumpLearner : public FeaturewiseLearner
{
public:
   ...
   * the object.
   */
   virtual ~RandomSingleStumpLearner() {}
   ...
   * \date 14/11/2005
   */
   virtual BaseLearner* subCreate() { return new RandomSingleStumpLearner(); }
   ...
   */
	...
	virtual void setTrainingData(InputData *pTrainingData) {
	   ...
	   if ( RandomSingleStumpLearner::_numOfCalling == 0 ) {
			init();
	   }
	}
