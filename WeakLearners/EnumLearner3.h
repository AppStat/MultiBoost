...
#ifndef __ENUM_LEARNER3_H
#define __ENUM_LEARNER3_H
...
*/
class EnumLearner3 : public FeaturewiseLearner
{
public:
   ...
   * \date 21/05/2007
   */
   virtual BaseLearner* subCreate() { return new EnumLearner3(); }
