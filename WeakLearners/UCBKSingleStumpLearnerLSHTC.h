...
#ifndef __UCBK_SINGLE_STUMP_LEARNER_LSHTC_H
#define __UCBK_SINGLE_STUMP_LEARNER_LSHTC_H
...
*/
class UCBKSingleStumpLearnerLSHTC : public FeaturewiseLearner
{
public:
   ...
   * the object.
   */
   virtual ~UCBKSingleStumpLearnerLSHTC() {}
   ...
   * \date 14/11/2005
   */
   virtual BaseLearner* subCreate() { return new UCBKSingleStumpLearnerLSHTC(); }
