...
/**
* \file SingleStumpLearnerLSHTC.h A single threshold decision stump learner. 
*/

#ifndef __SINGLE_STUMP_LEARNER_LSHTC_H
#define __SINGLE_STUMP_LEARNER_LSHTC_H
...
*/
class SingleStumpLearnerLSHTC : public FeaturewiseLearner
{
public:
   ...
   * the object.
   */
   virtual ~SingleStumpLearnerLSHTC() {}
   ...
   * \date 14/11/2005
   */
   virtual BaseLearner* subCreate() { return new SingleStumpLearnerLSHTC(); }
