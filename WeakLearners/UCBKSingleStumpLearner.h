...
#ifndef __UCBK_SINGLE_STUMP_LEARNER_H
#define __UCBK_SINGLE_STUMP_LEARNER_H
...
*/
class UCBKSingleStumpLearner : public FeaturewiseLearner
{
public:
   ...
   * the object.
   */
   virtual ~UCBKSingleStumpLearner() {}
   ...
   * \date 14/11/2005
   */
   virtual BaseLearner* subCreate() { return new UCBKSingleStumpLearner(); }
