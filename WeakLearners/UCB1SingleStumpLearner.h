...
#ifndef __UCB1_SINGLE_STUMP_LEARNER_H
#define __UCB1_SINGLE_STUMP_LEARNER_H
...
*/
class UCB1SingleStumpLearner : public FeaturewiseLearner
{
public:
   ...
   * the object.
   */
   virtual ~UCB1SingleStumpLearner() {}
   ...
   * \date 14/11/2005
   */
   virtual BaseLearner* subCreate() { return new UCB1SingleStumpLearner(); }
