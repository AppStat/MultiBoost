...
/**
* \file BrownBoostLearner.h The meta-learner AdaBoostLearner.MH.
*/
#pragma warning( disable : 4786 )

#ifndef __BROWNBOOST_LEARNER_H
#define __BROWNBOOST_LEARNER_H
...
* \date 12/11/2005
*/
class BrownBoostLearner : public GenericStrongLearner
{
public:
   ...
   */
   ...
   /**
   * Performs the classification using the BrownBoostClassifier.
   * \param args The arguments provided by the command line with all
...
private:
   ...
   * \date 6/12/2005
   */
   BrownBoostLearner& operator=( const BrownBoostLearner& ) {return *this;}
