...
/**
* \file TreeLearner3.h A single threshold decision stump learner. 
* \date 24/04/2007
*/

#ifndef __TREE_LEARNER3_H
#define __TREE_LEARNER3_H
...
*/
class TreeLearner3 : public BaseLearner
{
public:
   ...
   * \date 26/05/2007
   */
   TreeLearner3() : _numBaseLearners(-1) { }

   /**
   * The destructor. Must be declared (virtual) for the proper destruction of 
   * the object.
   */
   virtual ~TreeLearner3() {
   ...
   * \date 14/11/2005
   */
   virtual BaseLearner* subCreate() { return new TreeLearner3(); }
